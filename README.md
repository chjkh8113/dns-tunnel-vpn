...
|----------|----------|------|
| **Windows** | [dns-tunnel-windows-v1.0.2.zip](https://github.com/chjkh8113/dns-tunnel-vpn/releases/download/v1.0.2/dns-tunnel-windows-v1.0.2.zip) | 6.6 MB |
| **Linux** | [dns-tunnel-linux-v1.0.2.tar.gz](https://github.com/chjkh8113/dns-tunnel-vpn/releases/download/v1.0.2/dns-tunnel-linux-v1.0.2.tar.gz) | 6.6 MB |
| **macOS (M1/M2/M3)** | [dns-tunnel-macos-arm64-v1.0.2.tar.gz](https://github.com/chjkh8113/dns-tunnel-vpn/releases/download/v1.0.2/dns-tunnel-macos-arm64-v1.0.2.tar.gz) | 5.9 MB |
